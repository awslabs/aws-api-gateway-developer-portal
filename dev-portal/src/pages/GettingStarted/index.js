...
export default (props) => (
  <div>
    ...
    <ol style={{listStyle: 'decimal', paddingLeft: '1.5rem', marginBottom: '1rem'}}>
      <li>Set up a developer account. Developer accounts here are managed by <a href='http://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-identity-pools.html' target='_blank'>AWS Cognito User Pools.</a></li>
      <li>Subscribe to an API and get an <a href='https://docs.aws.amazon.com/apigateway/api-reference/resource/api-key/' target='_blank'>API Key</a>. Once you get it, you can use it for all the API products published here.</li>
